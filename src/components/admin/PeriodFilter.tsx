...
type Preset = 'today' | '7d' | '15d' | '1m' | '6m' | '1y' | 'custom'
...
/** Helper para Server Components: parsea from/to de searchParams. Si no hay
 *  params, devuelve el rango de los últimos 6 meses (default) o `null` para
 *  hoy si el preset es 'today'. */
